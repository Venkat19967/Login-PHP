...
<div class="wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                ...
                                <div class="footer">
                                    ...
                                    <hr>
                                    <div class="stats">
                                        <i class="ti-timer"></i> Frequent Updates
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="card ">
                            <div class="header">
                                <h4 class="title">2017 Statistics</h4>
                                <p class="category">Data Processing Pattern</p>
                            </div>
                            <div class="content">
                                ...
                                <div class="footer">
                                    <div class="chart-legend">
                                        <i class="fa fa-circle text-info"></i> Old Data
                                        <i class="fa fa-circle text-warning"></i> New Data
                                    </div>
                                    <hr>
                                    <div class="stats">
	...
	<script type="text/javascript">
    	$(document).ready(function(){
        	...
        	$.notify({
            	// icon: 'ti-gift',
            	message: "Welcome to <b>Vismaya Admin Panel</b>"
